...
\subsection{History}
  ...
  declarative UI patterns, was introduced. It took some concepts of
  ...
  Unlike var which can be accessed outside the function it was initialized
  ...
  memory safety guarantees without the need of a garbage collector.

...
\subsection{History}
  ...
  \section{Conclusion}
  Rust and JavaScript are two of the most well-loved modern programming
  languages---with JavaScript being one of the core languages for web technology
  ...
  C and C++ but with their paradigms as well.
